...
const WorkerRegistration = () => {
  ...
  const skillCategories = [
    'AC Technician', 'Agriculture', 'Babysitting', 'Carpenter', 
      ...
      <div className="min-h-screen bg-background pt-20 flex items-center justify-center px-6 relative overflow-hidden">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-2xl font-black mb-2 tracking-tight">{t('registration.headerTitle')}</h2>
            ...
            <div className="p-6 sm:p-8">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-xl font-black tracking-tight">{t('dashboard.myCredential')}</h2>
                </div>
                <div className="flex items-center gap-1.5 px-2.5 py-1 bg-green-500/10 border border-green-500/15 rounded-lg">
                  <div className="w-1.5 h-1.5 rounded-full bg-green-500 animate-pulse" />
                  <span className="text-[8px] font-black uppercase text-green-400">{t('dashboard.onChain')}</span>
                </div>
              </div>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 relative z-10">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-black tracking-tight">{t('registration.headerTitle')}</h1>
                <p className="text-white/30 text-xs font-medium">{t('registration.headerSubtitle')}</p>
              </div>
            </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <span className="relative z-10 flex items-center gap-3">
                        {isMinting ? (
                          <><Loader2 className="w-4.5 h-4.5 animate-spin" /> {t('registration.btnMinting')}</>
                        ) : filledCount === 5 ? (
