...
const Analytics = () => {
  ...
  /* ── Connected view ────────────────────────────────────────── */
  return (
    <div className="h-[calc(100vh-64px)] bg-[#0a0a0f] mt-16 py-5 px-6 relative overflow-hidden flex flex-col">
      ...
      <div className="max-w-[1600px] w-full mx-auto relative z-10 flex flex-col h-full">
        ...
        {/* ── Header ──────────────────────────────── */}
        <div className="mb-4 flex flex-col md:flex-row md:items-end justify-between gap-3 shrink-0">
          <motion.div
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 flex-1 min-h-0">
          ...
          >
            ...
            {/* Chart body */}
            <div className="p-5 pt-3 flex-1 min-h-0" style={{ width: '100%', minWidth: 200 }}>
